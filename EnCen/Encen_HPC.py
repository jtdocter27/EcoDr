...
soil = '/projects/jodo9280/EcoDr/EcoDr/EnCen/Lake_Sediment/img_data_295860-21'
...
# %%
final_folder = '/projects/jodo9280/EcoDr/EcoDr/EnCen/diamond_analysis_output'
desired_location = '/projects/jodo9280/EcoDr/EcoDr/EnCen/Lake_Sediment/img_data_295860-21'
...
def read_in_binary_matrix(synbio_binary, sb_name):
    ...
    domain_binary = pd.read_csv('/projects/jodo9280/EcoDr/EcoDr/EnCen/functional_profiles/Lake_Sediment_Metagenome_functional_profile',
                                  delimiter=" ", header=0)
