...
soil = '/projects/jodo9280/EcoDr/EcoDr/EnCen/Soil Endosphere Metagenome/img_data_295860-24'
abspath = os.path.abspath(soil)
name = 'kleb_endo_metagenome'
...
# %%
final_folder = '/projects/jodo9280/EcoDr/EcoDr/EnCen/diamond_analysis_output'
desired_location = '/projects/jodo9280/EcoDr/EcoDr/EnCen/Soil Endosphere Metagenome/img_data_295860-24'
...
def read_in_binary_matrix(synbio_binary, sb_name):
    ...
    domain_binary = pd.read_csv('/projects/jodo9280/EcoDr/EcoDr/EnCen/functional_profiles/kleb_endo_metagenome_functional_profile',
                                  delimiter=" ", header=0)
