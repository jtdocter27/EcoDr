...
# %%
final_folder = '/projects/jodo9280/EcoDr/EcoDr/EnCen/diamond_analysis_output'
desired_location = '/projects/jodo9280/EcoDr/EcoDr/EnCen/River_Sediment/img_data_295860-19'
...
def read_in_binary_matrix(synbio_binary, sb_name):
    ...
    domain_binary = pd.read_csv('/projects/jodo9280/EcoDr/EcoDr/EnCen/functional_profiles/River_Sediment_Metagenome_functional_profile',
                                  delimiter=" ", header=0)
