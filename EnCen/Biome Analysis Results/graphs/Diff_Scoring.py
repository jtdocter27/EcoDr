...
combined = pd.concat([cw5, ab5, as5, rs5, ls5], ignore_index=True)
# # combined = pd.concat([activated_sludge_df, ag_bulk_df, cow_rumen_df, lake_sediment_df, river_sediment_df], ignore_index=True)
# # print(combined)
...
sns.swarmplot(data=combined, x='Difference Score', y='Biome', hue = 'Biome', s=3, palette = 'pastel', legend = False)
plt.show()