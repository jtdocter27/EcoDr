...
def similarity_search(path, all_rxns_doc):
    ...
    if status == 1:
        ...
        analogous.to_csv('analogous.txt')
...
#ec_inchikeys is EC Number and InChi - Key
#analogous is 'Similair Structure Inchi-Keys
...
##Variable Definitions______________________________________________________________________________________________
...
##Code that runs the Above Defitions___________________________________________________________________________________
